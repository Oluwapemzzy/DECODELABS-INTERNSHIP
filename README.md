...
a. Evaluate the quality and integrity of the dataset before analysis. 
b. Clean and prepare the data for accurate reporting. 
c. Validate key business metrics rather than assuming their correctness. 
d. Measure product performance. 
e. Compare gross sales with realized revenue. 
f. Evaluate customer acquisition channels. 
g. Assess operational performance through order fulfillment metrics. 
f. Build an interactive dashboard suitable for executive reporting.
...
https://github.com/Oluwapemzzy/Decodelabs-Intership/tree/1405846fcca2a9093d236f8794e1a2442f073d78/Decodelabs
...
The dataset was reviewed to ensure every column contained the appropriate data type.
Examples include:
...
Categorical fields were standardized to eliminate inconsistencies caused by variations in text formatting.
...
A final review of the dataset was conducted to confirm that:
